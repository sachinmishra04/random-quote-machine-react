            ...
            <div id="quote-box" className="ui card-css cards">
                <div className=" ui raised card">
                    <div className="content">
                        ...
                        <p id="text" style={{color:props.color}} className={`${props.color} center aligned big description`}>
                           "{props.text}" 
                        </p>
                        <div id="author" style={{color:props.color}} className={`center aligned ${props.color} header`}>{`-${giveValidAuthor()}`}</div>
                    </div>

                    
                        <div class="ui two buttons">
                           <div> <a  href={`https://twitter.com/intent/tweet?text=${props.text}-${props.author}`} id="tweet-quote" class="ui basic green button">
                           <img src={logo} style={{width:`48px`,height:`48px`}} />
                            </a>
                           
                            </div>
                            <button id="new-quote" onClick={onCardClick} 
